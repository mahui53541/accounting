...
<div style="text-align: center;margin-top: 20px;">
    <object classid="clsid27CDB6E-AE6D-11cf-96B8-444553540000"
        ...
        <param name="movie" value="${pageContext.request.contextPath}/files/questionnaire.swf">
        <param name="quality" value="high">
        <%--<param name="wmode" value="transparent"> <!--这里代码可使Flash背景透明 -->--%>
        <embed src="${pageContext.request.contextPath}/files/questionnaire.swf" width="777" height="900"
               align="center"
               quality="high"
